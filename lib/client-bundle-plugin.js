...
export default function (inputOptionsFunc, outputOptions, resolveFileUrl) {
  let cache;
  ...
  return {
    ...
    load(id) {
      ...
      return [
        ...
        `export const src = import.meta.${allSrcPlaceholder + exportCounter};`,
      ].join('\n');
    },
    ...
    resolveImportMeta(property, { moduleId, format }) {
      ...
      if (property.startsWith(allSrcPlaceholder)) {
        return JSON.stringify(clientEntry.code);
      }
